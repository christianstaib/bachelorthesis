...
Dabei werden beim Lazy-Popping die Knoten oft nicht kontrahiert, sondern mit aktualisiertem Heuristik-Wert in die Warteschlange zurückgeschoben.
...
Um die Kontraktion des gesamten Graphen effizienter zu gestallten, müssen die Folgekosten unnötigerweise eingefügter Kanten geringer sein als der Zeitgewinn durch den Einsatz der Heuristik.

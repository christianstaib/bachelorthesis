...
\begin{tikzpicture}
    \begin{axis}[
            ...
            xlabel={Hop-Länge},
            ylabel={Fehler (\%)},
            legend style={at={(1,0.4)},anchor=east}
        ]
        \addplot+ table [x=hops, y=simple_graph_upper_bound, col sep=comma, mark phase=1, mark repeat=6] {data/bounds/aegaeis.csv};
        \addlegendentry{$\triangle$};

        \addplot+ table [x=hops, y=10, col sep=comma, mark phase=2, mark repeat=6] {data/bounds/aegaeis.csv};
        \addlegendentry{10 Hubs};

        \addplot+ table [x=hops, y=20, col sep=comma, mark phase=3, mark repeat=6] {data/bounds/aegaeis.csv};
        \addlegendentry{20 Hubs};

        \addplot+ table [x=hops, y=40, col sep=comma, mark phase=4, mark repeat=6] {data/bounds/aegaeis.csv};
        \addlegendentry{40 Hubs};

        \addplot+ table [x=hops, y=80, col sep=comma, mark phase=5, mark repeat=6] {data/bounds/aegaeis.csv};
...
\begin{tikzpicture}
    \begin{axis}[
        ...
        \addplot+ table [x=hops, y=simple_graph_upper_bound, col sep=comma, mark phase=1, mark repeat=6] {data/bounds/medi.csv};
        \addlegendentry{$\triangle$};

        \addplot+ table [x=hops, y=10, col sep=comma, mark phase=2, mark repeat=6] {data/bounds/medi.csv};
        \addlegendentry{10 Hubs};

        \addplot+ table [x=hops, y=20, col sep=comma, mark phase=3, mark repeat=6] {data/bounds/medi.csv};
        \addlegendentry{20 Hubs};

        \addplot+ table [x=hops, y=40, col sep=comma, mark phase=4, mark repeat=6] {data/bounds/medi.csv};
        \addlegendentry{40 Hubs};

        \addplot+ table [x=hops, y=80, col sep=comma, mark phase=5, mark repeat=6] {data/bounds/medi.csv};
        \addlegendentry{80 Hubs};
    \end{axis}
\end{tikzpicture}

...
\todo{Traingulierungen auch anzeigen.}
...
% `target/release/hl_predict_orderings -g ../graphs/aegaeis-ref-visibility.fmi -h /pfs/work7/workspace/scratch/st_st162081-graph_data/data_final/aegaeis-ref-visibility/hl_ch_bruteforce.bincode -l 1000 -p 1000000 -s tests/data/aegaeis-ref-graph_hl.bincode`
% hl:
% simple ordering                                                        1473.27
% hitting-set, then hits                                                 1420.17
% hitting-set, then random                                               1747.03
% hitting-set, then degree (small to large)                              1582.00
% hitting-set, then degree (small to large), then hits                   1609.93
% hitting-set, then degree (large to small)                              2147.25
% random                                                                 17811.58
% degree (small to large)                                                7420.85
% degree (large to small)                                                57435.23
%
% ch:
% simple ordering                                                        838.59
% hitting-set, then hits                                                 839.80
% hitting-set, then random                                               1117.53
% hitting-set, then degree (small to large)                              857.66
% hitting-set, then degree (small to large), then hits                   842.15
% hitting-set, then degree (large to small)                              1258.01
% random                                                                 3151.90
% degree (small to large)                                                925.99
% degree (large to small)                                                12964.08

% `target/release/hl_predict_orderings -g ../graphs/medi-ref-visibility.fmi -h /pfs/work7/workspace/scratch/st_st162081-graph_data/data_final/medi-ref-visibility/hl_ch_bruteforce.bincode -l 1000 -p 1000000 -s tests/data/medi-ref-graph_hl_witness.bincode`
% hl:
% simple ordering                                                        1930.65
% hitting-set, then hits                                                 2002.87
% hitting-set, then random                                               2487.06
% hitting-set, then degree (small to large)                              2422.12
% hitting-set, then degree (small to large), then hits                   2443.32
% hitting-set, then degree (large to small)                              3367.30
% random                                                                 18700.13
% degree (small to large)                                                12862.80
% degree (large to small)                                                78490.52
%
% ch:
% simple ordering                                                        1253.29
% hitting-set, then hits                                                 1357.61
% hitting-set, then random                                               1542.52
% hitting-set, then degree (small to large)                              1223.64
% hitting-set, then degree (small to large), then hits                   1252.87
% hitting-set, then degree (large to small)                              1892.62
% random                                                                 3611.29
% degree (small to large)                                                1377.39
% degree (large to small)                                                16523.42

% `target/release/hl_predict_orderings -g ../graphs/pata-ref-visibility.fmi -h /pfs/work7/workspace/scratch/st_st162081-graph_data/data_final/pata-ref-visibility/hl_ch_bruteforce.bincode -l 1000 -p 1000000 -s tests/data/pata-ref-graph_hl_witness.bincode`
% hl:
% simple ordering                                                        552.90
% hitting-set, then hits                                                 478.80
% hitting-set, then random                                               1100.42
% hitting-set, then degree (small to large)                              806.95
% hitting-set, then degree (small to large), then hits                   859.61
% hitting-set, then degree (large to small)                              2428.18
% random                                                                 23690.52
% degree (small to large)                                                10174.37
% degree (large to small)                                                115053.22
% 
% ch:
% simple ordering                                                        190.69
% hitting-set, then hits                                                 207.74
% hitting-set, then random                                               357.46
% hitting-set, then degree (small to large)                              213.76
% hitting-set, then degree (small to large), then hits                   194.37
% hitting-set, then degree (large to small)                              637.45
% random                                                                 1213.83
% degree (small to large)                                                228.77
% degree (large to small)                                                9335.24
...
\begin{table}[h!]
  ...
  \begin{tabular}{
      ...
      S[table-format = 3.0] % average time spd
...
\todo{Shortcuts durch Kanten, HL Werte}

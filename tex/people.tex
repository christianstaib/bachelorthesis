...
Hierfür geben wir eine neue Charakterisierung des Contracted- und Hub-Graphen und präsentieren anschließend PEOPLE (\textbf{P}r\textbf{E}determined \textbf{O}rder, \textbf{P}runed \textbf{L}ab\textbf{e}l), eine Methode, mit der hieriasche Hub-Graphen mit einer vorgegebenen vertex-to-Level-Funktion erstellt werden können, ohne dass eine Knoten-Kontraktion erforderlich ist.
...
\begin{figure}[h!]
  ...
  \begin{subfigure}[b]{0.49\textwidth}
    ...
    \end{tikzpicture}
    \caption{Upward- und Downard-Graph}
  \end{subfigure}
  \begin{subfigure}[b]{0.49\textwidth}
    \centering
    \begin{tikzpicture}[scale=0.8]
...
Ein Beispiel einer solchen Suche ist in \autoref{ch:fig:hl_brute_force_suchbaum} gezeichnet, dieses verwendet den Beispielgraph, aber nicht die gleiche vertex-to-level-Funktion wie in \autoref{ch::fig::vtl_abbildung}.
